	...
	<!--<script src="<?php bloginfo('template_url'); ?>/scripts/jquery-1.11.0.min.js"></script>-->
	<script src="<?php bloginfo('template_url'); ?>/scripts/royal-slider-1.0.min.js"></script>
	<script src="<?php bloginfo('template_url'); ?>/scripts/libs.js"></script>
